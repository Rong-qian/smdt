...
#
# 2023-04, RS:        While using only the right swager, tension comes out too high. Change target tension to 315 so that
#                     tubes pass first tension more often.
#
#                     Alexandru: Created global tension variable and a "tension-altering" variable so a new targert tension can easily be selected if needed
#
# 2023-04, Rongqian:  Adding mini tube into the database
#
# 2023-07, Rongqian:  The first tension is lower by 100g for the second tension be around 350g
...
#        manual_note1.setText("|                           1st Tension: 315.48 - 322.57 |  2nd Tension: 336.99 - 362.97                            |")
        ...
        self.target_tension = 320-100 #Change this value to alter tension, originally 319
                                ...
                                if(result == 1):
                                    ...
                                    if(result == 1):
                                        ...
                                        if(result == 1):
                                            ...
                                            if( (tension > (200-100)) and (tension < (500-100)) ):
                                                check = 0
                                            else:
                                                tension, frequency = self.measuring_auto_tension("Error, recalculating...")
                                                if( ( tension > (200-100)) and (tension < (450-100)) ):
                                                    check = 0
                                                else:
                                                    check1 = 2
                                            ...
                                            while(check == 0):
                                                ...
                                                if( (tension > (self.target_tension + 5)) and (tension < (350.00-100)) ):
                                                    self.decrease += 10
                                                    ...
                                                    if(result == 1):
                                                        ...
                                                        check1 = 2
                                                elif( (tension > (280.00-100)) and (tension < (self.target_tension - 5)) ):
                                                    self.increase += 10
                                                    target = external_int - self.decrease + self.increase
                                                    ...
                                                    if(result == 1):
                                                        ...
                                                        self.auto_reset_plus_status("Autotension cancelled, no tube data saved")
                                                        check1 = 2
                                                elif( (tension >= (350.00-100)) and (tension < (450-100)) ):
                                                    self.decrease += 50
                                                    target = external_int - self.decrease + self.increase
                                                    self.update_auto_status("Decreasing Tension")
                                                    stride = 1
                                                    ...
                                                    if(result == 1):
                                                        ...
                                                        self.auto_reset_plus_status("Autotension cancelled, no tube data saved")
                                                        check1 = 2
                                                elif( (tension > (200.00-100)) and (tension <= (280.00-100)) ):
                                                    self.increase += 50
                                                    target = external_int - self.decrease + self.increase
                                                    self.update_auto_status("Increasing Tension")
                                                    stride = 1
